...
// 	if (sizeof(senderHardwareAddress) / sizeof(senderHardwareAddress[0]) != 6 || sizeof(targetHardwareAddress) / sizeof(targetHardwareAddress[0]) != 6) {
// 		return -1;
// 	}
// 	if (sizeof(senderProtocolAddress) / sizeof(senderProtocolAddress[0]) != 4 || sizeof(targetProtocolAddress) / sizeof(targetProtocolAddress[0]) != 4) {
// 		return -1;
// 	}
